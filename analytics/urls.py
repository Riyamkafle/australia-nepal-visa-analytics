...
urlpatterns = [
    ...
    path('education-sector-comparison/', views.education_sector_comparison, name='api-education-sector-comparison'),
    ...
    path('forecast-backtest/', views.forecast_backtest, name='api-forecast-backtest'),
    ...
    path('applicant-type-comparison/', views.applicant_type_comparison, name='api-applicant-type-comparison'),
    path('provider-state-comparison/', views.provider_state_comparison, name='api-provider-state-comparison'),
    path('university-market-overview/', views.university_market_overview, name='api-university-market-overview'),
    path('applicant-location-cross/', views.applicant_location_cross, name='api-applicant-location-cross'),
